 ...
 * It does not interact with any real camera hardware or PhotonVision - all vision
 * measurements are read directly from logged {@link CameraIO.CameraData}.
 *
...
public class CameraReplay extends CameraIO {
     ...
     *
     * <p>Vision measurements are automatically populated from logs by AdvantageKit's
     * replay infrastructure, so no new pipeline results are needed.
     *
