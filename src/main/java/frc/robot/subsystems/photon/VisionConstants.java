...
public final class VisionConstants {
   ...
   *
   * <p>Each camera requires a name (for NetworkTables) and transform from robot center to camera
   * optical frame.
   */
   ...
   *
   * <p>Used by {@link edu.wpi.first.math.estimator.SwerveDrivePoseEstimator} to weight vision
   * measurements vs. odometry.
   */
